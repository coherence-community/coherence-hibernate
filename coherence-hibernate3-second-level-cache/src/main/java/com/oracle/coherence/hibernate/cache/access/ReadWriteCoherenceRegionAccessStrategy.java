/*
 * File: ReadWriteCoherenceRegionAccessStrategy.java
 *
...
extends CoherenceRegionAccessStrategy<T>
{
    ...
    // ---- interface org.hibernate.cache.access.RegionAccessStrategy
     ...
     */
    @Override
    public org.hibernate.cache.access.SoftLock lockItem(Object key, Object version) throws CacheException
    {
     ...
     */
    @Override
    public void unlockItem(Object key, org.hibernate.cache.access.SoftLock lock) throws CacheException
    {
     ...
     * 1. org.hibernate.cache.access.EntityRegionAccessStrategy.afterInsert(Object key, Object value, Object version) and
     * 2. org.hibernate.cache.access.NaturalIdRegionAccessStrategy.afterInsert(Object key, Object value).
     *
    ...
    /**
     * Coherence-based implementation of behavior common to:
     * 1. org.hibernate.cache.access.EntityRegionAccessStrategy.afterUpdate(Object key, Object value, Object currentVersion, Object previousVersion, SoftLock lock) and
     * 2. org.hibernate.cache.access.NaturalIdRegionAccessStrategy.afterUpdate(Object key, Object value, SoftLock lock).
     *
     * The only difference in implementation is that the cache value in a NaturalIdRegion will have a null version object.
     *
     * @param key the key at which to insert a value
