...
----
java -jar samples/coherence-hibernate-demo/coherence-hibernate-demo-app/target/coherence-hibernate-demo-app-4.0.0-SNAPSHOT.jar
----
...
[source,bash,indent=1,subs="verbatim,quotes,attributes"]
----
java -jar samples/coherence-hibernate-demo/coherence-hibernate-demo-server/target/coherence-hibernate-demo-server-4.0.0-SNAPSHOT.jar
----
...
[source,bash,indent=1,subs="verbatim,quotes,attributes"]
----
java -jar samples/coherence-hibernate-demo/coherence-hibernate-demo-app/target/coherence-hibernate-demo-app-4.0.0-SNAPSHOT.jar --spring.profiles.active=remote
----
...
-jar coherence-hibernate-demo-server/target/coherence-hibernate-demo-server-4.0.0-SNAPSHOT.jar
----
...
----
java -DauthenticationToken=my_secret_token  \
-jar coherence-hibernate-demo-app/target/coherence-hibernate-demo-app-4.0.0-SNAPSHOT.jar \
