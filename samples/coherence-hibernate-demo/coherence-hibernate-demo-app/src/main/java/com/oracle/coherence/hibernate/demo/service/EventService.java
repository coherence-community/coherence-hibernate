...
public interface EventService {
     ...
     * @param usingJpaQuery the event and the respective participants will be queried using a Jpa query
     * @param withParticipants if true, participants will be returned as well. Only used if usingJpaQuery is false.
     * @return an Event. Never null.
