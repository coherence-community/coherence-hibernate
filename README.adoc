...
[width="75%"]
|=======
|*{main-release-version}* | https://docs.coherence.community/coherence-hibernate/docs/latest/[Website] | https://docs.coherence.community/coherence-hibernate/docs/latest/api/index.html[API Doc.]
