...
The default `4.x` build uses Hibernate ORM `7.4.5.Final` and Coherence CE `15.1.1-0-5`. The Java 17 compatibility
matrix additionally tests Hibernate `7.4.1.Final` and `7.4.5.Final` with both Coherence `15.1.1-0-5` and `26.07`.
