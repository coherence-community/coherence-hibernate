...
[width="75%"]
|=======
|*{snapshot-version}* | {website}{snapshot-version}[Website] | {website}{snapshot-version}/refdocs/api/index.html[API Doc.]
|*{release-version}* | {website}{release-version}[Website] | {website}{release-version}/refdocs/api/index.html[API Doc.]
|=======
