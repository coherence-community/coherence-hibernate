:main-release-version: 3.0.0-SNAPSHOT
:main-snapshot-version: 3.0.0-SNAPSHOT
:2x-release-version: 2.3.2
:2x-snapshot-version: 2.3.3-SNAPSHOT
...
|*{2x-release-version}*    | `11` | `22.06`      |            | `2.3.2`
