...
|*4.0.x*             | `17`, `21`, `25` | `15.1.1-0-2`, `25.03.1` | `7.4.x`       | ✔       | `main`
...
The default `4.x` build uses Hibernate ORM `7.4.5.Final` and Coherence CE `15.1.1-0-2`. The Java 17 compatibility
matrix additionally tests Hibernate `7.4.1.Final` and `7.4.5.Final` with both Coherence `15.1.1-0-2` and `25.03.1`.
...
|*{main-snapshot-version}* | `17`, `21`, `25` | `15.1.1-0-2`, `25.03.1` | ✅       | `main`
...
Coherence Hibernate `4.x` CI brackets the supported Hibernate `7.4.x` line with `7.4.1.Final` and the current default
`7.4.5.Final`. The default dependency combination is tested on every supported Java version; alternate dependency
combinations are tested on Java 17, the project's bytecode baseline.
