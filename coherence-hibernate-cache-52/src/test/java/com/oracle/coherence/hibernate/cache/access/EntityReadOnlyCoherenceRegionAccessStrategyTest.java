...
extends AbstractCoherenceRegionAccessStrategyTest
{
    ...
    public void testUpdate()
    {
        try
        {
            ...
            accessStrategy.update(sessionImplementor, key, value, currentVersion, previousVersion);
    ...
    public void testAfterUpdate()
    {
        try
        {
            ...
            accessStrategy.afterUpdate(sessionImplementor, key, value, currentVersion, previousVersion, softLock);
            fail("Expect CacheException updating read-only access strategy");
        }
        catch (UnsupportedOperationException ex)
        {
