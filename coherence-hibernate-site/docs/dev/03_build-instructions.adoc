...
- https://www.oracle.com/java/technologies/downloads/[Java SE Development Kit 17, 21, or 25].
...
https://github.com/coherence-community/coherence-hibernate/blob/main/README.adoc[README] of the Coherence Hibernate
