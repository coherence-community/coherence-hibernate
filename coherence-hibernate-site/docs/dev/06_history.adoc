...
* Compatibility-test Hibernate `7.4.1.Final` and `7.4.5.Final` with Coherence CE `15.1.1-0-5` and `26.07` on the
  Java 17 bytecode baseline, in addition to the complete default-version reactor on Java 17, 21, and 25.
