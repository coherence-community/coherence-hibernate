...
https://github.com/coherence-community/coherence-hibernate/archive/main.zip

[IMPORTANT]
====
*Pull Requests* are welcome! Just make sure to become an official
https://github.com/coherence-community/coherence-hibernate/blob/main/CONTRIBUTING.adoc[contributor].
====